<%-- 
    Document   : Tipo_Docu
    Created on : Aug 25, 2016, 12:05:30 PM
    Author     : aerc
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-5">
                    <form action="tipo_docuServ" method="Post">
                ...
                <div class="col-md-7">
                <jsp:useBean id="doc" class="com.sv.udb.Controlador.tipo_docuCtrl" scope="page"/>
                <div class="col-md-7">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <c:forEach items="${doc.consTodo()}" var="fila">
                            <tr>
